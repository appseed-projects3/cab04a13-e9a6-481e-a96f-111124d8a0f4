...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-12 12:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cab04a13-e9a6-481e-a96f-111124d8a0f4.git
$ cd cab04a13-e9a6-481e-a96f-111124d8a0f4
```
